...
public class RattenFangerV2 {
	...
	public static long[] unPackV9(long[] r, int counter) {
		...
		if (r[r.length-1]>0) {
			...
			//bitL = BitSet.valueOf(r).length()-1;
		...
		//	if ( (bitL > 91) && (bitL < 96) ) {
			...
			//	System.out.println(BitSet.valueOf(r));
				...
				if (a[0] == b[0]) {
					/*
						String bits = "11101100000000011101100011000011000000101000001";
		...
		*/
		...
		do {
			...
			if (bitL==107) {
				System.out.println(BitSet.valueOf(r));
				System.out.println((bitlength+1)/4);
			}
			*/

			b= r.clone();
			//if ((bitL-bitlength-1==3) ) {
			if ((bitL-bitlength==3) ) {
				if(((b[0]>>>(i-1)) & 1) == 0) {
					return new long[] {-1};
				}
...
//			b = shiftL(b,1);
	...
	public static void main(String[] args) {
		...
		//   bits = "1000011111001001110111111101001010100101010000101100101100011000100111000100111111000100"; // 20
		//   bits = "111111011110010000010010101101100010011100001111110011100000011100 1011111010001101110110"; // 21
		//   bits = "100011000010101001100101110000000110010001110100001010111111101110001000011100011000"; // 22
		//   bits = "10101101100010011111100100000011000100000000010101010001000011011110000000100111010"; //25
		//   bits = "101110011100000011111001111111000010101111111110000000001011101001011101100111010001"; //26
		//   bits = "100110011000000110000011010100000001000000100101101010110010001111011110111001101110"; //27
		//   bits = "110110111001111011101000001000010101101100010011010001001110001111010000000110011101"; // 28
		//   bits =   "100110000000001111011000111000110100100111101010001011100000000111010010100110100010" ; //34
		//   bits =    "11010010000100110111011010110000010110011000100011100011011001110000010100101101110"; //51
		//   bits =    "110100000000010101111111110110100100001001101101000100110001100001010000010111111111"; //75
		//   bits =    "10000000101111000010101100010110010001011001111101000101000000100001110001000100011"; //76
		//   bits =    "100000101001001101111100010010011000101010111001000001010010011000100110011101001000"; //77
		//   bits =    "111010110011111011100110111101100110000101010110010110111100111101001011111000000001"; //78
		//   bits =    "1100011001001110000110110001101110101100011000100100001000001110110100000011101100"; //79
		//   bits =    "11001110011111110011110001100001111110000111011100100000001011001010101101101010011"; //80 
		//   bits =    "110111011000110001011000000011011100110000001110101101100101011000111001101100000100"; //81
		//   bits =    "10010111011101111000010011011000001100110101110011110100000100111101011101100001100"; //82
		//   bits =    "100100100100011010110011001110101001111101000110001100100000011011110010111010111101"; //83
		 //  bits =    "110010100110100011011101110000100110011010000110000010001100010100010011100000010111"; //84 
		//   bits =    "11101110111010010011010110110111110000111011101001011111001111110111100010011000100"; //85
		 //  bits =    "111111111100110101010100001001010010010000110000100011100011100000011111011011111010"; //86
		 //  bits =    "11010101100010101010100011000111001011111001000110000101111100000000110101011"; //87
		//   bits =    "1111000110010000001110001011001000100011001111000110101101100010100000000100100"; //89
		...
		*/
		...
		// BitSet f = unPackV5(bs,90);
		 ...
		 if ((bitL) % 4 >0){
		  ...
		  long [] f = unPackV9(bs.toLongArray(),100);
...
public static long[] unPackV7(long[] r, int counter, int blocks) {
	long[] a;
	long[] b;
	long[] ab;
	int bitL;
	...
	*/
	...
	int start= (bitL+1)/4; //minimum number of blocks
	if (start<blocks || start<18) {
	//if (start<blocks || start<4) {
	//	System.out.println(BitSet.valueOf(r));
	//return new long[] {-2};
	}
